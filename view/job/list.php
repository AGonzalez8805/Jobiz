        ...
        <div class="flex flex-wrap">
            <?php foreach ($jobs as $job): ?>
                ...
                <div class="xl:w-1/4 lg:w-1/2 md:w-full px-8 py-6 border-l-2 border-gray-200 border-opacity-60">
                    <h2 class="text-lg sm:text-xl text-gray-900 font-medium title-font mb-2"><?= $job->getTitle() ?>Shooting Stars</h2>
                    <p class="leading-relaxed text-base mb-4"><?= substr($job->getDescription(), 0, 110)  ?>...</p>
